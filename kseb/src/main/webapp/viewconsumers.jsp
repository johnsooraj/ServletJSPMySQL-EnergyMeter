...
<title>Administrator | View Consumers</title>
...
<body>
	<div class="container">
			...
			<div class="container-fluid">
				...
				<ul class="nav navbar-nav">
					...
					<li role="presentation" class="active"><a
						onclick="viewConsumers()">view consumers</a></li>
		...
		<section class="content-header">
			<h1>All Users</h1>
			<p>
				<c:out value="${sessionScope.newlistdata}"></c:out>
			</p>
		</section>
		<section>
			<div class="col-md-12">
						...
						<div class="table-responsive mailbox-messages">
							<table class="table table-hover table-striped">
								<tbody>
									...
									<c:forEach var="userdata" items="${sessionScope.userdatas}">
										<tr>
											...
											<td class="mailbox-name"><a href="#"><c:out
														value="${userdata.customerData.fullName}"></c:out></a></td>

											<td class="mailbox-subject"><b><c:out
														value="${userdata.customerData.houseName}"></c:out> <c:out
														value="${userdata.customerData.houseNumber}"></c:out><br>
													<c:out value="${userdata.customerData.postOffice}"></c:out>
											</b></td>
											<td><c:out value="${userdata.customerData.email}"></c:out></td>
											<td><c:out
													value="${userdata.customerData.transformarDetails.transformarSection}"></c:out></td>
											<td></td>
										</tr>
